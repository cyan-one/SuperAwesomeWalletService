  ...
  return Padding(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          ...
          hintText: hintText,
          filled: true,
          fillColor: App_edit_text_background,
          enabledBorder: OutlineInputBorder(
            borderRadius: BorderRadius.circular(40),
            borderSide: const BorderSide(
                color: App_edit_text_background, width: 0.0),
          ),
...
Text formHeading(var label) {
  return Text(label,
      style: TextStyle(
          color: App_textColorPrimary, fontSize: 30, fontFamily: 'Bold'),
...
Text formSubHeadingForm(var label) {
  return Text(label,
      style: TextStyle(
          color: App_textColorSecondary, fontSize: 20, fontFamily: 'Bold'),
      textAlign: TextAlign.center);
}
...
Text formLink(var label) {
  return Text(label,
      style: TextStyle(color: App_blue, fontSize: 18),
      textAlign: TextAlign.center);
}
...
Material shadowButton(var name) {
  return Material(
      ...
      child: SizedBox(
        ...
        height: 60,
        child: MaterialButton(
          child: text(name,fontSize: textSizeLargeMedium,textColor: App_white,fontFamily: fontMedium),
          textColor: App_white,
          shape: RoundedRectangleBorder(
              borderRadius: new BorderRadius.circular(40.0)),
          color: AppColorPrimary,
...
Text Heading(var label) {
  return Text(label,
      style: TextStyle(
          color: App_textColorPrimary, fontSize: 18, fontFamily: 'Bold'),
      textAlign: TextAlign.left);
}
  ...
  return Row(
    children: <Widget>[
      Padding(
          ...
          child: text(label,fontSize: textSizeLargeMedium,textColor: AppTextColorPrimary,maxLine: maxline)),
    ],
  );
}
...
Text profile(var label) {
  return Text(label,
      style: TextStyle(
          color: AppColorPrimary, fontSize: 18, fontFamily: 'Medium'),
      textAlign: TextAlign.center);
}
...
Text listHeading(var label) {
  return Text(label,
      style: TextStyle(
          color: App_textColorPrimary, fontSize: 20, fontFamily: 'Bold'),
      textAlign: TextAlign.left);
}
Text listDesignationHeading(var label) {
  return Text(label,
      style: TextStyle(
          color: App_textColorPrimary, fontSize: 16, fontFamily: 'Medium'),
      textAlign: TextAlign.left);
}
...
Text listOther(var label) {
  return Text(label,
      style: TextStyle(
          color: App_textColorSecondary, fontSize: 16,),
      textAlign: TextAlign.left);
}
...
Text headerText(var text) {
  return Text(
    ...
    maxLines: 2,
    style: TextStyle(
        fontFamily: fontBold, fontSize: 22, color: App_textColorPrimary),
  );
}
...
Text subHeadingText(var text) {
  return Text(
    text,
    style: TextStyle(
        fontFamily: fontBold, fontSize: 17.5, color: App_textColorSecondary),
  );
}

Widget text(var text,
    {var fontSize = textSizeLargeMedium,
      textColor = App_textColorSecondary,
        ...
        child: Container(
          decoration: const BoxDecoration(
            gradient: LinearGradient(
                colors: <Color>[AppColorPrimary, AppColorPrimaryDark]),
...
class EditText extends StatefulWidget {
  ...
  EditText(
      {var this.fontSize = textSizeNormal,
        var this.textColor = App_textColorSecondary,
...
Widget ring(String description){
  return Column(
    ...
    children: <Widget>[
      ...
      SizedBox(height: 16),
      text(description,textColor: AppTextColorPrimary,fontSize: textSizeNormal,fontFamily: fontSemibold,isCentered: true,maxLine: 2)
    ],
  );
}
...
BoxDecoration boxDecoration(
    {double radius = 2,
      ...
      Color bgColor = App_white,var showShadow=false}) {
