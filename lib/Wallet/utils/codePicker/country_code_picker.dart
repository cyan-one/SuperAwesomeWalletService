...
import 'package:saws/Wallet/utils/codePicker/selection_dialog.dart';
      ...
      _widget = FlatButton(
        ...
        child: Flex(
          ...
          children: <Widget>[
            ...
            Flexible(
              fit: widget.alignLeft ? FlexFit.tight : FlexFit.loose,
              child: text(selectedItem.toCountryCodeString(),textColor: AppTextColorPrimary,fontSize: textSizeMedium),
            ),
          ],
        ),
      );
