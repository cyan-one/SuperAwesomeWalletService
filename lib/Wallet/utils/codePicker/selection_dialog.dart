...
import 'package:saws/main/utils/AppWidget.dart';
...
class _SelectionDialogState extends State<SelectionDialog> {
  ...
  Widget build(BuildContext context) => SimpleDialog(
      title: Column(
        ...
        children: <Widget>[
          text("Select Country Code",textColor: AppTextColorPrimary,fontSize: textSizeNormal,fontFamily: fontSemibold),
          TextField(
        ...
        children: <Widget>[
          ...
          Expanded(
            ...
            child: Row(
              ...
              children: <Widget>[
                Expanded(child: text(e.toLongString(),fontSize: textSizeMedium,textColor: AppTextColorPrimary)),
                text(e.dialCode,fontSize: textSizeMedium,textColor: AppTextColorPrimary,fontFamily: fontSemibold),
              ],
            ),
          ),
        ],
