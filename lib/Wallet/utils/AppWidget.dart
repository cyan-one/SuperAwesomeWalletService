...
class EditText extends StatefulWidget {
  ...
  EditText(
      ...
      var this.textColor = AppTextColorSecondary,
    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        enabledBorder: OutlineInputBorder(
          ...
          borderSide: const BorderSide(color: AppViewColor, width: 0.0),
        ),
      ...
      child: Container(
        ...
        child: Stack(
          children: <Widget>[
            ...
            Center(child: text(widget.titleName,textColor: AppTextColorPrimary,fontSize: textSizeNormal,fontFamily: fontBold))
          ],
        ),
      ),
    );
...
BoxDecoration boxDecoration(
  ...
  return BoxDecoration(
      ...
      boxShadow: showShadow
          ? [BoxShadow(color: AppShadowColor, blurRadius: 10, spreadRadius: 2)]
