...
class AppCarouselSlider extends StatefulWidget {
  ...
  /// The initial page to show when first creating the [AppCarouselSlider].
  ///
  /// Defaults to 0.
  ...
  /// Animates the controlled [AppCarouselSlider] to the next page.
  ///
  ...
  /// Animates the controlled [AppCarouselSlider] to the previous page.
  ///
  /// The animation lasts for the given duration and follows the given curve.
  /// The returned [Future] resolves when the animation completes.
  ...
  /// Changes which page is displayed in the controlled [AppCarouselSlider].
  ///
  ...
  /// Animates the controlled [AppCarouselSlider] from the current page to the given page.
  ///
  /// The animation lasts for the given duration and follows the given curve.
  /// The returned [Future] resolves when the animation completes.
